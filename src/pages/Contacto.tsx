...
const Contacto = () => {
  ...
  return (
    <div>
      <HeroSection 
        backgroundImage="https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=2940&ixlib=rb-4.0.3"
        title="Contacto"
        subtitle="Estamos aquí para responder a todas sus preguntas sobre servicios oftalmológicos."
        credentials={false}
      />
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-4">
                    ...
                    <input 
                      ...
                      required
                      className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-clinic-blue"
                    />
                  </div>
                  ...
                  <button 
                    ...
                    className="w-full bg-clinic-blue text-white py-3 px-4 rounded-md hover:bg-clinic-dark transition duration-300 flex items-center justify-center"
                  >
                    {isSubmitting ? (
      ...
      <section className="py-12">
        <div className="container mx-auto px-6">
          ...
          <div className="rounded-lg overflow-hidden shadow-lg h-96">
            <iframe 
              src="https://www.google.com/maps/d/embed?mid=1MxglC7Iwc34AzCbSbdDqZwTzP177ZCD4" 
